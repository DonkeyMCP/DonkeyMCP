...
// Show Banner
const showBanner = () => {
    const banner = figlet.textSync('donkeymcp', { font: 'Big' });
    console.log(yellow(banner));
    console.log(yellow('🚀 Welcome to the donkeymcp Configurator\n'));
};
...
const configureClaude = async (config: object): Promise<boolean> => {
    ...
    console.log(yellow('✅ donkeymcp configured for Claude Desktop. Please RESTART your Claude to enjoy it 🎉'));
    return true;
};
